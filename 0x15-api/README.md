...
__0. Gather data from an API__</br>
Write a Python script that, using this [REST API](https://jsonplaceholder.typicode.com/), for a given employee ID, returns information about his/her TODO list progress.</br>
...
- The script must display on the standard output the employee TODO list progress in this exact format:
	...
	- Second and N next lines display the title of completed tasks: `TASK_TITLE` (with 1 tabulation and 1 space before the `TASK_TITLE`)</br>
Example:
```Bash
...
sylvain@ubuntu$
```
__1. Export to CSV__</br>
Using what you did in the task #0, extend your Python script to export data in the CSV format.</br>
...
sylvain@ubuntu$
```
__2. Export to JSON__</br>
Using what you did in the task #0, extend your Python script to export data in the JSON format.</br>
...
```
__3. Dictionary of list of dictionaries__</br>
Using what you did in the task #0, extend your Python script to export data in the JSON format.</br>
...
- File name must be: `todo_all_employees.json`</br>
Example:
```Bash
